...
public class ClassAssignments {
    int[] anArray = { 2, 50, 490, 5, 16, 49, 34, 22, 80, 1883};
    int[][] multiDimensionalArray = { {0, 0, 0, 0, 0},
                    {0, 1, 2, 3, 4},
                    {0, 2, 4, 6, 8},
                    {0, 3, 6, 9, 12},
                    {0, 4, 8, 12, 16} };
    ...
    public void sumArray(){
        int sum=0;
        for(int element : this.anArray){//Iterates through the array without specifing an index
